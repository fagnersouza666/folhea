...
**YOU ARE IN: `folhea/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/folhea/` (rig root) or other directories
...
**Your mail address:** `folhea/polecats/obsidian`
**Your rig:** folhea
**Your Witness:** `folhea/witness`
...
| Ask Witness for help | `gt mail send folhea/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`folhea/witness`) when:
...
```bash
gt mail send folhea/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
