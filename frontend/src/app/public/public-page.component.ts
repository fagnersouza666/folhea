...
export const publicPages: Record<string, PublicPage> = {
  ...
  privacidade: {
    ...
    blocks: [
      ...
      { title: '4. Segurança e retenção', text: 'Aplicamos controles técnicos para reduzir riscos de acesso indevido e mantemos os dados enquanto sua conta for necessária para o serviço ou enquanto houver obrigação legal. Exclusões e solicitações são avaliadas conforme a legislação aplicável.' },
      { title: '5. Seus direitos', text: 'Você pode pedir confirmação de tratamento, acesso, correção ou exclusão dos seus dados, além de esclarecer dúvidas sobre esta política. Fale conosco pelo e-mail oi@folhea.com.br.' },
